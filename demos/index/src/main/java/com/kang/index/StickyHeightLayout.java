 ...
 */
public class StickyHeightLayout extends LinearLayout
{
    ...
    public StickyHeightLayout(Context context)
    {
        this(context, null);
    }

    public StickyHeightLayout(Context context, AttributeSet attrs)
    {
        super(context, attrs);
