...
public class Custom3DView extends ViewGroup
{
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
    {
        ...
        int childWidthMeasureSpec = MeasureSpec.makeMeasureSpec(measureWidth - (params.leftMargin + params.rightMargin),
                MeasureSpec.EXACTLY);
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom)
    {
        ...
        for (int i = 0; i < getChildCount(); i++)
        {
            ...
            if (child.getVisibility() != GONE)
            {
                ...
                child.layout(params.leftMargin, childTop, child.getMeasuredWidth() + params.leftMargin,
